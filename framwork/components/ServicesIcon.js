import { faArrowDown, faArrowLeft, faArrowRight, faLightbulb, faMobileScreenButton, faSquarePhone, faTelevision } from "@fortawesome/free-solid-svg-icons";
...
export const ServicesIcons = [
    ...
    { name: "cable_tv", icon: faTelevision, rotate: 0, color: "#0024da", background: "#0024da2d" },
    { name: "electricity", icon: faLightbulb, rotate: 0, color: "#c68e01", background: "#c68e0131" },
]