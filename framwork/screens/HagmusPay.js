...
export function HagmusPay({ navigation }) {
    ...
    <AppSafeAreaView style={styles.container}>
      <View style={styles.body}>
        ...
        <View style={{ alignItems: 'center', marginBottom: 15 }}>
          <Text style={{ fontWeight: 'bold', fontSize: 23, color: 'white' }}>Send {selectedCoin.name == "" ? "USDT" : selectedCoin.name}</Text>
          <Text style={{ fontWeight: 'bold', fontSize: 11, color: '#787A8D' }}>Send {selectedCoin.name == "" ? "USDT" : selectedCoin.name} to a Hagmus user account</Text>
        </View>
            ...
            >
              <View style={{
                ...
                {selectedCoin.img == null && selectedCoin.name == "" ?
                  <Text style={{ color: '#787A8D', fontSize: 15 }}>Select Asset</Text> :
