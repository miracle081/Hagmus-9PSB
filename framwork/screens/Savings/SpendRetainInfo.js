                ...
                <View style={styles.body}>
                    ...
                    <View style={styles.vault}>
                        ...
                        <TouchableOpacity
                            onPress={closeModal2}
                            style={{
                                backgroundColor: '#7B61FF', marginHorizontal: 20, padding: 10,
                                borderRadius: 8, alignItems: 'center', flexDirection: 'row', justifyContent: 'space-evenly'
                            }}>
                            <Text style={{ color: '#fbfaff' }}>Set savings percentage</Text>
                            <FontAwesomeIcon icon={faChevronRight} color="#fbfaff" />
                        </TouchableOpacity>
